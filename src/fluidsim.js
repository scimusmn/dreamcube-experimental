...
export const createSim = (gl, w, h) => {
  ...
  const advect = (field, source, dt) => {
    ...
    gl.uniform1i(gl.getUniformLocation(advectProgram, 'field'), field);
  ...
  const stripDiv = (field) => {
    ...
    gl.uniform1i(gl.getUniformLocation(stripDivProgram, 'field'), field);
